...
function sampleNssNcc(i: number): Record<string, unknown> {
    ...
    return {
        ...
        highestCertificate: i % 2 === 0 ? 'Camp' : 'B',
...
function sampleHighestSalary(i: number): Record<string, unknown> {
    ...
    return {
        ...
        companyName: d.company, jobRole: d.role,
        placementType: i % 2 === 0 ? 'on-campus' : 'off-campus',
        basePayLpa: d.ctc * 0.8, ctcLpa: d.ctc,
...
function sampleCoreSalary(i: number): Record<string, unknown> {
    ...
    return {
        ...
        companyName: d.company, jobRole: d.role,
        placementType: i % 2 === 0 ? 'on-campus' : 'off-campus',
        basePayLpa: d.ctc * 0.85, ctcLpa: d.ctc,
        coreDomain: d.domain,
